...
|<img src="https://user-images.githubusercontent.com/50905347/189133279-66dae6fe-de42-43f2-91de-fd9a84da58a8.gif" width="256" height="256">|```WheelPicker(count = 6) { index, snappedIndex -> Card(Modifier.size(128.dp).padding(8.dp)) {} }```|
